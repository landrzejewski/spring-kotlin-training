...
import pl.training.payments.utils.annotations.Atomic
...
class AtomicAspect(
    ...
    @Around("@annotation(pl.training.payments.utils.annotations.Atomic) || within(@pl.training.payments.utils.annotations.Atomic *)")
