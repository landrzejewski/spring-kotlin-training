...
class AtomicAspect(
    ...
    @Around("@annotation(pl.training.payments.utils.aop.Atomic) || within(@pl.training.payments.utils.aop.Atomic *)")
    @Throws(Throwable::class)
    fun runWithTransaction(joinPoint: ProceedingJoinPoint): Any? {
        val annotation = Annotations.findAnnotation(joinPoint, Atomic::class)
        val transactionDefinition =
            if (annotation != null) transactionDefinition(annotation) else DefaultTransactionDefinition()
